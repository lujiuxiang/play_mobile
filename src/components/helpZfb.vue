    ...
    <div class="service">
        ...
        <div class="content">
            <ul>
                <li>
                    <p>
                        <i>1</i>点击 "转账" + 进入 "转账页面"</p>
                    <img src="../../static/images/zfb/help1.jpg" alt="">
                </li>
                <li>
                    <p>
                        <i>2</i>点击 "转到银行卡"</p>
                    <img src="../../static/images/zfb/help2.jpg" alt="">
                </li>
                <li>
                    <p>
                        <i>3</i>填写收款人相关信息，点击"下一步完成支付"</p>
                    <img src="../../static/images/zfb/help3.jpg" alt="">
                </li>
            </ul>
        </div>
        <!-- 内容 结束 -->
